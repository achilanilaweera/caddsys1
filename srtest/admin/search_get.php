...
$nic2 = $_POST['search-box'];




$query = "select nic,fname,lname,gender,dob,email,phone,occupation,type,state,image,discription from employee where nic='$nic2'";
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <?php echo "You are about to update $nic2 Account" ; ?>
								...
								<div class="form-group ">
								   ...
								   height:150px;
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nic" name="nic" type="text" value="<?php echo $nic2; ?>" readonly>
                                        </div>
                                    </div>
