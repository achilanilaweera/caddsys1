            ...
            <div class="col-lg-12">
                   ...
                   <form role="form-horizontal" method="post" action="profile_q.php" name="form1" id="form1" enctype="multipart/form-data" >
                                 ...
                                 <label for="to" class="">Description</label>
                                    ...
                                    <!--<input type="text"  id="email" class="form-control"  style="white-space:pre-line; height:5; width:5" name="discription" value='<?php echo $discription; ?> ' >-->
                                       <textarea name="discription" id="discription" cols="45" rows="5"><?php echo $discription; ?></textarea>
