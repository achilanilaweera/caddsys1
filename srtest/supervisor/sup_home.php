  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      ...
      <div class="">
        ...
        <form method="post" action="sup_search.php" id="myForm8" name="myForm4">
<input type="text" id="search-box" name="search-box" required placeholder="Search By NIC or Name..." 
form="myForm8" size="15" name="nicpost" autocomplete="off" />
...
<div id="suggesstion-box" align="center"></div>
	...
	$sql= "SELECT sr.status_id, sr.status, sr.date, sr.time, ws.work_id, e.fname FROM  status_report sr, employee e, worker w,  work_status ws WHERE sr.status_id= ws.status_id  and ws.work_id=w.work_id and w.w_nic=e.nic order by sr.status_id DESC";
