...
$rows = mysqli_num_rows($result);
	if ($rows == 1){
			 if (($typex =='Admin')||($typex =='Supervisor'))
				{
...
$query3="select max(status_id)+1 as sys from status_report";
...
$query6="select work_id as sys from worker where w_nic='".$con->real_escape_string($_SESSION['nic'])."'";
        ...
        <!-- notification dropdown start-->
           <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                        <li><a href="work_home.php">Inbox</a></li>
                        <li><a href="add.php">Add Status</a></li>
                </li>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        <!--<li>
         ...
         <form class="form-inline" method="post" action="work_srch.php" >
        
            <input type="text" name="date"class="form-control search" placeholder="Search Date.." >
