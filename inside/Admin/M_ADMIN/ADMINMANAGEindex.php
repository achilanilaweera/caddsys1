		...
		$rdt='<div class="container" id="c">
																	  ...
																	  <div class="panel-group">
																		...
																		<div class="form-group">
																		  ...
																		  <p style="color:red;">(  4 - Finance | 3 - Basic Level| 2 - Branch Manager | 1 : Top Level )</p>
...
if(isset($_POST['crteusr'])){
	...
	//	VALUES ('".$_SESSION['username']."','".time().",'newaccount','".date("Y-m-d")."','fff')";
	...
	// new file size in KB
												...
												$resultd = mysqli_query($con, $queryin);
															...
															if (!($resultd ))
															...
															else
															  {
																...
																$details='Level '.$ll.' account created for '.$nn.'';
																
																$sqCl = "INSERT INTO log (log_admin_id,start_time,end_time,date,log_details)
																VALUES ('".$_SESSION['username']."','".time()."','newaccount','".date("Y-m-d")."','".$details."')";
															  ...
															  <strong>Success! : New user created</strong>
															</div>';
		...
		$queryin="insert into admin(admin_id,name,email,username,branch_id,level,password,profile) values (null,'$nn','$ee','$uu', '$bb','$ll','$pp','user.png')";
						...
						if($ll==1||$ll==2||$ll==3){
										...
										if (!($resultup ))
										...
										else
										  {
																...
																$details=''.$nn.'`s Account details updated!';
...
?>
                          ...
                          <p>
                            ...
                            <select name="level" class="form-control">
                              <option value="3">Basic Level</option>
