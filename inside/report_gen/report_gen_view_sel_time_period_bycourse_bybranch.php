...
{ //echo "NO RECORDS FOUND FOR SELECTED TIME PERIOD";	
 echo "<script>alert('NO RECORDS FOUND FOR SELECTED DATE'); window.location.href = 'index.php?tab=report_gen_home'; </script>";
}
}
...
{ 
      echo "    <div class='clearfix'></div>";
               echo "   </div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'>SUMMARY FOR SELECTED TIME PERIOD</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
...
//find only reg students without payment

if(isset($_POST["findonlyreg"]))   
{	
...
/*
$query = "SELECT * FROM student s, payment p, course c, student_branch sb, branch b, student_course sc where s.std_id = sb.std_id and sb.branch_id=b.branch_id and sc.course_id=p.course_id and s.std_id=p.std_id and s.std_id=sc.std_id and sc.course_id=c.course_id and s.regDate BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and sc.course_id like '$course22' and s.std_id not in (select px.std_id from payment px where px.std_id=s.std_id and px.course_id=sc.course_id) and sb.branch_id like '$branch22' order by b.name asc , p.course_id  ";
*/

$query = "SELECT * FROM student s, course c, student_branch sb, branch b, student_course sc where s.std_id = sb.std_id and sb.branch_id=b.branch_id and s.std_id=sc.std_id and sc.course_id=c.course_id and s.std_id not in (select px.std_id from payment px where px.std_id=s.std_id and px.course_id=sc.course_id) and sc.sc_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and sc.course_id like '$course22' and sb.branch_id like '$branch22' order by b.name asc, s.std_id ";
...
echo "    <div class='clearfix'></div>";
	echo "</div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'> CADD CENTER - REPORT FOR THE SELECTED TIME PERIOD $mydate2 to $mydate1 Students Who have Registered, but Course Fee Not Paid</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
                     echo "   <tr>";
                     echo "     <th>Student ID</th>";
					...
					echo " <th>Branch</th>";
					echo "	  <th>Student Reg Date</th>";
				echo "	  <th>Course Reg Date</th>";
...
echo "<td class='stillpaying'>{$sc_date}</td>";

echo "<td class='instnotstarted'>{$regFee}</td>";
...
//view students for that perticular course registration
...
.higherthan100{
 ...
 color:black;   
		...
		$query = "SELECT * FROM student s, payment p, course c, student_branch sb, branch b, student_course sc, course_installment ci,payment_receipt pr where s.std_id = sb.std_id and sb.branch_id=b.branch_id and s.std_id=p.std_id and s.std_id=sc.std_id and sc.course_id=p.course_id and sc.course_id=c.course_id and s.std_id=pr.pr_std_id and sc.course_id=pr.pr_course_id and sc.course_id=ci.course_id and sc.sc_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and p.type='FullPay' and sc.course_id like '$course22' and sb.branch_id like '$branch22' order by b.name asc , p.course_id  ";
...
echo "    <div class='clearfix'></div>";
             ...
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'>Report Course Registration in $mydate2 to $mydate1 - Full Payment Plans</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
                     echo "   <tr>";
                     echo "     <th>Student ID</th>";
...
$query99 = "SELECT * FROM student s, payment p, student_branch sb, branch b, payment_installment pi,course c,student_course sc, course_installment ci where s.std_id = sb.std_id and sb.branch_id=b.branch_id and s.std_id=p.std_id and s.std_id=sc.std_id and sc.course_id=c.course_id and sc.course_id=p.course_id and s.std_id=pi.std_id and sc.course_id=pi.course_id and sc.course_id=ci.course_id and sc.sc_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and p.type='HalfPay' and sc.course_id like '$course22' and sb.branch_id like '$branch22' order by b.name asc , p.course_id  ";
...
if( $num_results99 > 0)
	{ //it means there's already a database record
         echo "    <div class='clearfix'></div>";
               echo "   </div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'> Report for Course Reg in $mydate2 to $mydate1 - Installment Plans</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
                     echo "   <tr>";
                     echo "     <th>Student ID</th>";
...
//special student
$query20 = "SELECT * FROM student s, payment p, course c, student_branch sb, branch b, student_course sc where s.std_id = sb.std_id and sb.branch_id=b.branch_id and sc.course_id=p.course_id and s.std_id=p.std_id and p.type='SPC' and s.std_id=sc.std_id and sc.course_id=c.course_id and sc.sc_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and sc.course_id like '$course22' and sb.branch_id like '$branch22'  order by b.name asc , p.course_id  ";
...
echo "    <div class='clearfix'></div>";
	echo "</div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'> CADD CENTER - REPORT FOR THE SELECTED COURSE REGISTRATION TIME PERIOD $mydate2 to $mydate1 SPECIAL PLANS</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
                     echo "   <tr>";			 
					 echo "     <th>Student ID</th>";
...
//else
{
 echo "<script>alert('No Students Enrolled in Selected Time Period Found!'); window.location.href = 'index.php?tab=report_gen_home'; </script>";
}
						
}

//end  of course view complete student


//start summary for selected

if(isset($_POST["viewcoursesum"]))   
{
...
{ 
      echo "    <div class='clearfix'></div>";
               echo "   </div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'>Summary for the selected course/s from its registration date</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
...
$my_query = mysqli_query($con, "SELECT * FROM payment_receipt pr,student s, student_branch sb, student_course sc where s.std_id = sc.std_id and s.std_id =pr.pr_std_id and pr.pr_std_id=sb.std_id and sb.branch_id like '$branch22'and sc.course_id=pr.pr_course_id and pr.pr_course_id='$course_id' and sc.sc_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' ") or die(mysqli_error($con));
...
{ //echo "NO RECORDS FOUND FOR SELECTED DATE";	
 echo "<script>alert('NO SUMMARY FOUND FOR SELECTED TIME PERIOD'); window.location.href = 'index.php?tab=report_gen_home'; </script>";
}
}

//find refund students
if(isset($_POST["refundinfo"]))   
{	
...
$query = "SELECT * FROM payment_refund_log prl,branch b, course c,student s where prl.r_std_id =s.std_id and prl.r_course_id =c.course_id and prl.r_branch_id=b.branch_id and prl.refund_date BETWEEN '" . $mydate2 . "' AND  '" . $mydate1 . "' and prl.r_course_id like '$course22' and prl.r_branch_id like '$branch22' order by prl.refund_id desc";
...
echo "    <div class='clearfix'></div>";
	echo "</div>";
             echo "     <div class='x_content'>";
            echo "<p class='text-muted font-13 m-b-30'> CADD CENTER - REPORT FOR THE SELECTED TIME PERIOD $mydate2 to $mydate1 Refund Information</p>";
               echo "     <table id='datatable' class='table table-striped table-bordered'>";
                   echo "   <thead>";
                     echo "   <tr>";
                     echo "     <th>Student ID</th>";
					...
					echo "    <th>Discount Reason</th>";

					//echo "	  <th>Course Reg Date</th>";

					
					echo "	  <th>Refunded Reason</th>";
					
					echo "	  <th>Refunded Date</th>";
					
					echo "	  <th>Refunded Amount</th>";
					echo "	  <th>Refunded Handled By</th>";
...
echo "<td>{$name}</td>"; //branch name

echo "<td>{$c_name}</td>";

echo "<td>{$old_total_course_fee}</td>";

echo "<td>{$old_discount}</td>";

echo "<td>{$old_discount_reason}</td>";



//echo "<td>{$old_course_reg_date}</td>";



echo "<td class='stillpaying'>{$refund_reason}</td>";



echo "<td class='stillpaying'>{$refund_date}</td>";

echo "<td class='instnotstarted'>{$refund_amount}</td>";

echo "<td class='instnotstarted'>{$refund_handledby}</td>";

$totalrefund = $totalrefund + $refund_amount;	
echo "</tr>";
	}
}
...
echo "<td class='fullcomplete'>TOTAL REFUNDS</td>";
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'></td>";
...
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'></td>";
echo "<td class='fullcomplete'>{$totalrefund}</td>";
echo "<td class='fullcomplete'></td>";
echo "</tr>";
//end of while
