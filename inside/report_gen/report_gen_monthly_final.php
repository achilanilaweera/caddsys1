...
//get the month to a variable
 ...
 <div class="btn-group">			
	  <input type="button" class="btn btn-info" value="Summary Chart" onClick="getmonth()" data-toggle="tooltip" title="View Number of Students Registered for the courses and Total Income received from all the branches (New Registrations + Course Fee's)"/> 						   
...
<br><br>	
       ...
       <!--  <input type="text" class="form-control" name="item23" id="item23" placeholder="Choose From..." form="myForm91"  \>-->
		...
		<br>
		       ...
		       <div class="btn-group">
					<input type="submit" name="export_complete" class="btn btn-primary" value="Export Complete" form="myForm91"  data-toggle="tooltip" title="Export Payments to the selected course/branch by all types, installment payments or special payments that have started on selected month..." />
                      <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                      </button>
					  ...
					  <br>
						...
						<br>
						  <li>   <input type="submit" name="export_SPCPay" class="btn btn-primary" value="Export SpecialPayments " form="myForm91"/>
						  </li>
		...
		<!-- end new button group-->
						   ...
						   <input type="submit" name="export_viewsummary" class="btn btn-success" value="Export Summary" form="myForm91" data-toggle="tooltip" title="Export the final income for selected course/all and selected branch/all in the given month."/>
 </div>
      </form>
