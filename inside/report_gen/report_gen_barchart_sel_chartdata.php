...
$pastmonth = date ("Y-m-d", strtotime ($todayis ."-30 days"));

$query = "SELECT distinct regDate as ddate, count(std_id) as cst from student where regDate  BETWEEN '" . $pastmonth . "' AND  '" . $todayis . "'  group by ddate";
