  ...
  <body class="nav-md">
			...
			<?php
				...
				*/
					...
					$query = "SELECT s.fname,s.lname, s.nic, s.std_id, s.regDate, c_name, c.course_fee, p.tot_amount, c.course_id FROM student s, payment p, student_course sc, course c WHERE s.std_id=p.std_id and s.std_id=sc.std_id and  c.course_id=sc.course_id and p.type='FullPay' and p.approvalState='TC' and s.nic='$nicGOT' and sc.course_id= '$course_idGOT' and p.course_id= '$course_idGOT'";
			...
			<div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" method="post" action="pay/full_payment_changed_dis_q.php">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name='type' value='FullPay/ChangedDiscount' disabled >
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" name='tot_amount' class="form-control" value='<?php echo $tot_amount;  ?>' readonly >	
...
<!--
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
							...
							<input type="text" class="form-control" name="mypaid" id="mypaid" placeholder="Enter your Payment"  \>
                        </div>
                      </div>
					  -->
