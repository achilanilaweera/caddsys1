			...
			$(document).ready(function () {
				...
				<script>
						...
						if((x>100)||(x<0))
							...
							{
							alert("Payment Discount Level requires Management Permission. Do Check your payment status in few days for any changes.");
							}
			...
			<div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" method="post"  action="pay/fullpay1_q.php">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name='type' value='FullPay' readonly="readonly" >
                        </div>
                      </div>
...
function getfullc_fee()
{
    ...
    document.getElementById('totalPrice').value = fullfee;
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input  onkeyup="getdiscount();" type="text" name='txt1' id="txt1" class="form-control" value='<?php echo $course_fee;  ?>' readonly="readonly" >	
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" onkeyup="getdiscount(); checkdiscount();" type="text" name="txt2" id="txt2" value="" >	
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control"  type="text" name="txt3" id="txt3" value="" readonly >	
