...
//	echo "got";
//	echo "$nic";echo "$course_id";echo "$studentID";
?>
...
<html lang="en">
  ...
  <body class="nav-md">
			...
			//	$action = isset( $_POST['action'] ) ? $_POST['action'] : "";
				...
				limit 0,1";
		*/
	$query = " SELECT * FROM student s, payment p, course c, student_branch sb, branch b, student_course sc where s.std_id = sb.std_id and sb.branch_id=b.branch_id and sc.course_id=p.course_id and s.std_id=p.std_id and s.std_id=sc.std_id and sc.course_id=c.course_id and p.std_id ='$studentID' and p.course_id ='$course_id' order by b.name asc , p.course_id  ";
			...
			<div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" method="post" action="pay/alter_discount_selected_q.php">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Total amount to be Paid OLD :</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" type="text" name="predisc" id="predisc" value='<?php echo $discount_given; ?>' readonly="readonly">	
                        </div>
                      </div>
					  ...
					  <br>
					    ...
					    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Reason for previous Discount :</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" type="text" name="remark22" value='<?php echo $discount_remark; ?>' readonly>
                        </div>
                      </div>
					  
					    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Discount Modified Date :</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="item23" id="item23" placeholder="Choose Day..." value="<?php echo date("Y-m-d"); ?>"  \>								  
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Reason for Discount Change :</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">New Discount :</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
						...
						<input type='hidden' name='tot_amount_old' value='<?php echo $tot_amount_old ?>' />
				...
				<!-- so that we could identify what record is to be updated 
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <input type='submit' value='Change Discount' class="btn btn-success" />
						  <button class="btn btn-primary" onClick="document.location.href='index.php?tab=alterdiscount'" type="button" >Go Back</button>  
