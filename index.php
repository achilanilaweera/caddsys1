...
<body>
 <nav class="navbar" id="top">
    <div class="inner">
      <a href="http://caddcentre.lk//" target="_blank">WWW.CADDCENTRE.LK</a>
    </div>
  </nav>
...
<h3 style="color:#900;"><?PHP if(isset($_SESSION['successstatus'])){ echo $_SESSION['successstatus'];}?></h3>
...
<br>
    ...
    <label><a  href="../sys1/inside/Lecture/login.php"> Lecturer Login</a> </label>
	<br><br>
    ...
    <input type="submit" value="Forgot password?" name="req">
